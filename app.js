...
const Grupos = [
	{ chat: "puxadas_nbs2", bot: "AnoninoBuscasOfcBot" },

];

//COLOCA SEUS BAGULHO AQ

const apiId = "15148725"; //https://my.telegram.org/auth
const apiHash = "c1ae37bd59193b9d721c79cc87c51cb7"; //https://my.telegram.org/auth
const stringSession = new StringSession("")
...
(async () => {
	await telegram.start({
		phoneNumber: "5548935059231", // SEU NUMERO DE TELEFONE AQUI DA CONTA DO TELEGRAM QUE DESEJA USAR!
...
if (!user) { return res.status(403).json({error: '➭ Chave da API inválida ou você não possui uma api-key' })}
 ...
 if (type.search(/cpf|cpf2|cpf3|cpf4|cpf5|cpf6|tel|tel2|tel3|cnpj|cep2|score|nome|nome2|nome3|nome4|parentes|beneficios|placa|placa2|placa3|site|ip|cep|bin|email|telefone|placa|vacina/) === -1) return res.send('Tipo de consulta invalida');
			...
			try {
               ...
               "str": "[⚠️] INVALIDO! [⚠️]"
				...
				//	str = str.replace(/\n\n\n/gi, "\n\n");
					...
					str = str.replace(/⚠️ PRECISANDO DE API'S REST? ACESSE: @SISTEMASARCADIAN/gi, "");
					str = str.replace(/👤 USUÁRIO: Teddy/gi, "");
					str = str.replace(/🤖 BY: @AnoninoBuscasOfcBot/gi, "");
                    str = str.replace(/👤 USUÁRIO: Teddy\n🤖 BY: @AnoninoBuscasOfcBot/gi, "");
